...
const AlphabetButton = ({ character }: AlphabetButton) => {
	return (
		<button className='relative bg-black text-menu-neutral border-4 border-menu-neutral rounded-2xl w-24 h-20 px-2 py-1.5 hover:bg-menu-yellow hover:text-black active:bg-menu-gold'>
