...
export const createMenuButtonClass = (isPressed: boolean) =>
	`container-row justify-center gap-3 rounded-xl uppercase w-full ${
		!isPressed ? 'bg-black text-menu-stone-text' : 'bg-menu-yellow text-black'
	} font-serif text-5xl py-1 text-center border-4 border-menu-gray hover:bg-menu-yellow hover:text-black active:bg-menu-gold disabled:brightness-50`;
